...
while(player1wins < 3 && player2wins <3) {
  ...
  if(weaponOfChoice1 === 'rock' && weaponOfChoice2 === 'scissors') {
    ...
    player1wins++;
    console.log('Player 1 wins');
  } else if(weaponOfChoice1 === 'rock' && weaponOfChoice2 === 'paper') {
    player2wins++;
    console.log('Player 2 wins');
  } else if(weaponOfChoice1 === 'paper' && weaponOfChoice2 === 'scissors') {
    player2wins++;
    console.log('Player 2 wins');
  } else if(weaponOfChoice1 === 'scissors' && weaponOfChoice2 === 'rock') {
    player2wins++;
    console.log('Player 2 wins');
  } else {
